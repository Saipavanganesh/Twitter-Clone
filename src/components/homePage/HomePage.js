      ...
      <div className="hp-right-box">
        <div className="hp-form-content">
          ...
          <div className="hp-buttons">
            ...
            <div className="hp-create-account" onClick={handleSignupClick}>
              <button className="hp-create-account">Create account</button>
            </div>
            <div className="hp-terms">
              By signing up, you agree to the
              <a className="hp-bottom-span-text" href="">
                {" "}
                Terms of Service
              </a>{" "}
              and
          ...
          <div className="hp-already-account">
            <div className="hp-text">
              <p className="hp-asking-text">
                <b>Already have an account?</b>
              </p>
            </div>
            <div className="hp-sign-in-button" onClick={handleLoginClick}>
